...
#define FOURTH3_SKILLID 6501		// 4次職3スキルIDの開始値
...
#define MAX_FOURTH1_SKILLID ( 5507+1)	// 4次職1スキルIDの終了値
#define MAX_FOURTH2_SKILLID ( 6007+1)	// 4次職1スキルIDの終了値
#define MAX_FOURTH3_SKILLID ( 6522+1)	// 4次職1スキルIDの終了値
...
#define MAX_FOURTH3SKILL (MAX_FOURTH3_SKILLID - FOURTH3_SKILLID)
...
#define MAX_SKILL_DB (MAX_SKILL+MAX_SECONDSKILL+MAX_THIRD1SKILL+MAX_THIRD2SKILL+MAX_THIRD3SKILL+MAX_THIRD4SKILL+MAX_FOURTH1SKILL+MAX_FOURTH2SKILL+MAX_FOURTH3SKILL+MAX_HOMSKILL+MAX_MERCSKILL+MAX_ELEMSKILL+MAX_ABRSKILL+MAX_GUILDSKILL)
#define MAX_PCSKILL  MAX_FOURTH3_SKILLID		// PCが使用可能の最大のスキルID
