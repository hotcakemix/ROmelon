...
#define MAX_HAT_EFFECT 256		//HAT_EFFECTの最大数　れもん追加
...
struct map_session_data {
	...
	short hotkey_set;
	char hotkey_rotate[MAX_HOTKEYS_TAB];
	int shop_point;
...
enum {
	...
	OPT_ATTR_TOLERACE_TELEKINESIS,OPT_ATTR_TOLERACE_UNDEAD,OPT_ATTR_TOLERACE_ALLNO,	// 33-35　れもん修正allnoに
	...
	OPT_ATTR_TOLERACE_ALL,	//193れもん追加ここから
	RACE_WEAPON_TOLERACE_NOTHING, RACE_WEAPON_TOLERACE_UNDEAD, RACE_WEAPON_TOLERACE_ANIMAL, RACE_WEAPON_TOLERACE_PLANT,	// 194-197
	RACE_WEAPON_TOLERACE_INSECT, RACE_WEAPON_TOLERACE_FISHS, RACE_WEAPON_TOLERACE_DEVIL, RACE_WEAPON_TOLERACE_HUMAN,	// 198-201
	RACE_WEAPON_TOLERACE_ANGEL, RACE_WEAPON_TOLERACE_DRAGON,	// 202-203
	RANGE_WEAPON_ATTACK_DAMAGE_TARGET, RANGE_WEAPON_ATTACK_DAMAGE_USER,	// 204-205
	RACE_TOLERACE_PLAYER_HUMAN, RACE_TOLERACE_PLAYER_DORAM, RACE_DAMAGE_PLAYER_HUMAN, RACE_DAMAGE_PLAYER_DORAM,	// 206-209
	RACE_MDAMAGE_PLAYER_HUMAN, RACE_MDAMAGE_PLAYER_DORAM, RACE_CRI_PERCENT_PLAYER_HUMAN, RACE_CRI_PERCENT_PLAYER_DORAM,	// 210-213
	RACE_IGNORE_DEF_PERCENT_PLAYER_HUMAN, RACE_IGNORE_DEF_PERCENT_PLAYER_DORAM,	// 214-215
	RACE_IGNORE_MDEF_PERCENT_PLAYER_HUMAN, RACE_IGNORE_MDEF_PERCENT_PLAYER_DORAM,	// 216-217
	REFLECT_DAMAGE_PERCENT, MELEE_ATTACK_DAMAGE_TARGET, MELEE_ATTACK_DAMAGE_USER,	// 218-220
	ADDSKILLMDAMAGE_NOTHING, ADDSKILLMDAMAGE_WATER, ADDSKILLMDAMAGE_GROUND, ADDSKILLMDAMAGE_FIRE, ADDSKILLMDAMAGE_WIND, ADDSKILLMDAMAGE_POISON,	// 221-226
	ADDSKILLMDAMAGE_SAINT, ADDSKILLMDAMAGE_DARKNESS, ADDSKILLMDAMAGE_TELEKINESIS, ADDSKILLMDAMAGE_UNDEAD,	// 227-230
	ADDSKILLMDAMAGE_ALL,	// 231
	ADDEXPPERCENT_KILLRACE_NOTHING, ADDEXPPERCENT_KILLRACE_UNDEAD, ADDEXPPERCENT_KILLRACE_ANIMAL, ADDEXPPERCENT_KILLRACE_PLANT,	// 232-235
	ADDEXPPERCENT_KILLRACE_INSECT, ADDEXPPERCENT_KILLRACE_FISHS, ADDEXPPERCENT_KILLRACE_DEVIL, ADDEXPPERCENT_KILLRACE_HUMAN,	// 236-239
	ADDEXPPERCENT_KILLRACE_ANGEL, ADDEXPPERCENT_KILLRACE_DRAGON, ADDEXPPERCENT_KILLRACE_ALL,	// 240-242
	OPT_POWAMOUNT, OPT_SPLAMOUNT, OPT_STAAMOUNT, OPT_WISAMOUNT, OPT_CONAMOUNT, OPT_CRTAMOUNT,	// 243-248
	OPT_PATKAMOUNT, OPT_SMATKAMOUNT, OPT_RESAMOUNT, OPT_MRESAMOUNT, OPT_HEAL_PLUS, OPT_CRITICAL_RATE,	// 249-254
