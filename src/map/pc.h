...
//int pc_equippedmatchcount(struct map_session_data* sd, const int *id_list, bool* slot_used);		//ÇÍÇ‡ÇÒí«â¡ëïîıçáívêî
//bool pc_isequipped(struct map_session_data* sd, int nameid);					//ÇÍÇ‡ÇÒí«â¡ëïîıçáív
